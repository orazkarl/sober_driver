...
class Order(models.Model):
    ...
    second_address = models.CharField('Второй адрес', max_length=255, null=True, blank=True)
    third_address = models.CharField('Третий адрес', max_length=255, null=True, blank=True)
    fourth_address = models.CharField('Четвертый адрес', max_length=255, null=True, blank=True)
