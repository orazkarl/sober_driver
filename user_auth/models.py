...
class User(AbstractUser):
    ...
    bio = models.CharField('Информация о водителя', max_length=50, null=True, blank=True)
    disctrict = models.CharField('Район проживание', max_length=20, null=True, blank=True)
